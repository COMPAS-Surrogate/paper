...
\subsection{MSSFR parameters and $\Mc-z$ rates}\label{sec:method_parameters}
Following \citep{Riley:2023:ApJ}, we vary four free parameters for the calculation of the \ac{MSSFR} in the phenomenological model of \citet{Neijssel_2019}. In this model, the \ac{MSSFR} is split into two parts, the star formation rate (SFR) and the metallicity distribution:
...
Varying these parameters in \COMPAS results in different merger rate distributions (see \citep{Riley:2023:ApJ, Neijssel_2019}). 
